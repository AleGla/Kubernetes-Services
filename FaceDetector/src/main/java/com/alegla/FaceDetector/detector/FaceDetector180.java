...
@Component
public class FaceDetector180 {
	
	private static final Logger LOG = LogManager.getLogger(FaceDetector180.class);
	...
	public String getFaceDetector180(Request data) throws IOException {
		...
		//Rotation 180°
		Mat dst = new Mat();
		ToolsDetection.rotateImage(resizeImage, dst, -1);

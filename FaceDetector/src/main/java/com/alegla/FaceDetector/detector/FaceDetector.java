package com.alegla.FaceDetector.detector;
...
import com.alegla.FaceDetector.tools.ToolsDetection;

@Component
public class FaceDetector {
	
	private static final Logger LOG = LogManager.getLogger(FaceDetector.class);
	...
	public String getFaceDetector(Request data) throws IOException {
	...
	//	switch(data.getAttempt()) {
	//		case 2:
	//			LOG.info("Get inside case 2");
	//			Mat dst = new Mat();
	//			ToolsDetection.rotateImage(resizeImage, dst, Core.ROTATE_90_CLOCKWISE);
	//			break;
	//		case 3:
	//			LOG.info("Get inside case 3");
	//			Mat dst2 = new Mat();
	//			ToolsDetection.rotateImage(resizeImage, dst2, Core.ROTATE_90_COUNTERCLOCKWISE);
	//			break;
	//		case 4:
	//			LOG.info("Get inside case 4");
	//			Mat dst3 = new Mat();
	//			ToolsDetection.rotateImage(resizeImage, dst3, -1);
	//			break;

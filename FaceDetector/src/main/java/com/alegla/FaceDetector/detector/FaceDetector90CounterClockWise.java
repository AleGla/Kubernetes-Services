...
@Component
public class FaceDetector90CounterClockWise {
	
	private static final Logger LOG = LogManager.getLogger(FaceDetector90CounterClockWise.class);
	...
	public String getFaceDetector90CounterClockWise(Request data) throws IOException {
		...
		Mat dst = new Mat();
		ToolsDetection.rotateImage(resizeImage, dst, Core.ROTATE_90_COUNTERCLOCKWISE);
